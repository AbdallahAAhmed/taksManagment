		...
		<form>
			...
			<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
				...
				<h4 class="d-flex flex-center rounded-top">
					<span class="text-white">إشعارات جديدة</span>
					<span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{auth()->user()->tasks()->count()}} جديدة</span>
				</h4>
				<!--end::Title-->
				<!--begin::Tabs-->
					...
					<div class="scroll pr-7 mr-n7 ps" data-scroll="true" data-height="300" data-mobile-height="200"
						...
						<div class="d-flex align-items-center mb-6">
							...
							<div class="d-flex flex-column font-weight-bold">
								<a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">{{ $item->task_name }}</a>
